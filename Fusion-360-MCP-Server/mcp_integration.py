...
## CAM Workflow Operations

### get_cam_state - Query CAM Workspace
{
  "operation": "get_cam_state"
}
Returns: setups, operations, stock configuration, active setup, post-processor.

### get_tool_library - Query Available Tools
{
